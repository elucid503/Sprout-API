...
import { SproutAccountFlags, type PublicSproutAccount, type SproutAccount } from "../Structs/SproutAccount";

import { MakeRequest } from "./Request";
import { FetchRoutes } from "../Config/Routes";

export async function ForciblyUpdateIntegrationsForAccount(YourAccount: SproutAccount, AccountToUpdate: SproutAccount | PublicSproutAccount, NewIntegrationData: { Integrations: any, Service: string }): Promise<SproutAccountIntegrations | null> {
